...
ALARM_PATH := vendor/sky/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/sky/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/sky/prebuilt/common/media/audio/ringtones
